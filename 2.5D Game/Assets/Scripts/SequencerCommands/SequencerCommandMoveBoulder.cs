...
namespace PixelCrushers.DialogueSystem.SequencerCommands
{
    ...
    public class SequencerCommandMoveBoulder : SequencerCommand
    {
        private NetworkObject boulder;
        ...
        public void Awake()
        {
            ...
            boulder = referenceBlock.boulder;
            controller = boulder.GetComponent<cageDoorController>();
